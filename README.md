...
**Paper:** https://huggingface.co/datasets/math-ai/aime25

A benchmark for evaluating AI's ability to solve challenging mathematics problems from the
2025 AIME - a prestigious high school mathematics competition.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/aime2025`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/aime2025) |
| Group | Mathematics |
| Total samples | 30 |
...
- `huggingface` — `math-ai/aime25` (pinned)
...
```bash
inspect eval inspect_evals/aime2025 \
  --sample-id "<sample-id>" \

#!/usr/bin/env python3
"""Run ONE problem of aime2025 through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one aime2025 problem via TrustedRouter")
